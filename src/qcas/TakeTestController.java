...
public class TakeTestController implements Initializable {
    ...
    private ArrayList<Question> getQList() {
        ...
        questionList.add(new Question("MC", "E", "ABCDE1", "A", true, "B", false, "C", false, "D", false, "A"));
        questionList.add(new Question("MA", "E", "ABCDE2", "A", true, "B", true, "C", false, "D", false, "A,B"));
       questionList.add(new Question("FIB", "E", "ABCDE4 __________", "aayushb1", false, "", false, "", false, "", false, "aayushb1"));
        questionList.add(new Question("MA", "M", "ABCDE5", "A", true, "B", true, "C", true, "D", false, "A,B,C")); 
        questionList.add(new Question("TF", "E", "ABCDE3", "True", false, "", false, "", false, "", false, "True"));
